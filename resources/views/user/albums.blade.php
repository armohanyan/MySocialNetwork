          ...
          <div class="row gutters-sm mr-0">
            ...
            <div class="col-md-8 ">
              @if ( Auth::user()->id == $user->id )
                ...
                <form class="mt-3 form-control " action="{{ route('post.album') }} "  method="POST" novalidate>
                  @csrf
                  <div class="form-group">
                    <label for="album">Create Album</label>
                    <input type="text" name="album" class=" {{ $errors->has('album') ? 'is-invalid' : '' }} " 
                    id="album" aria-describedby="album" placeholder="Enter Album name">
                    @if( $errors->has('album'))
                      ...
                      <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="btn-group">
                              <a href="{{ route('get.image', [ 'username' => $user->username, 'albumId'=> $album->id ] ) }} " class="btn btn-sm btn-outline-secondary">View</a>
